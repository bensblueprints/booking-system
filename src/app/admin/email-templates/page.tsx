      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {TEMPLATE_TYPES.map((tt) => {
          ...
          return (
            <div
              key={tt.type}
              className="bg-white rounded-xl border border-slate-200 p-5 flex flex-col cursor-pointer hover:border-slate-300 transition-colors"
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-slate-900">{tt.label}</div>
                    <div className="text-xs text-slate-700">{tt.description}</div>
                  </div>
                </div>
                <button
                  onClick={(e) => {
                ...
                >
                  {isActive ? (
                    ...
                    <ToggleLeft className="w-5 h-5 text-slate-700" />
                  )}
                </button>
              </div>
              ...
              <div className="mt-auto pt-3 border-t border-slate-100">
                {tmpl?.subject ? (
                  ...
                  <div className="text-sm text-slate-600 italic">Not configured</div>
                )}
              </div>
        ...
        {editTemplate && (
          <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                {VARIABLES.map((v) => (
                  <button
                    ...
                    className="px-2 py-1 bg-white border border-slate-200 rounded text-xs font-mono text-brand-light hover:bg-slate-100 transition-colors"
                  >
                    {v}
                  </button>
                ))}
            ...
            <div className="pt-4 border-t border-slate-200">
              <div className="text-sm font-medium text-slate-900 mb-2">Send Test Email</div>
